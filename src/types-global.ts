...
declare var Buffer: {
  ...
  new(array: Uint8Array): Buffer; // tslint:disable-line
  /**
   ...
   */
  new(arrayBuffer: ArrayBuffer): Buffer; // tslint:disable-line
  /**
   * Allocates a new buffer containing the given {array} of octets.
   *
   * @param array The octets to store.
   */
  new(array: any[]): Buffer; // tslint:disable-line
  /**
   * Copies the passed {buffer} data onto a new {Buffer} instance.
   *
   * @param buffer The buffer to copy.
   */
  new(buffer: Buffer): Buffer; // tslint:disable-line
