...
const d3 = fs.readFileSync(resolve(root, 'src/vis/d3.min.js'), 'utf8')
const html = fs.readFileSync(resolve(root, 'src/vis/template.html'), 'utf8')
const out = `module.exports = \`${html.replace('__D3_PLACEHOLDER__', d3).replace('__SCRIPT_PLACEHOLDER__', script)}\``
